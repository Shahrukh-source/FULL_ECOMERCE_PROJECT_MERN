            ...
            <div className="col-lg-4 col-md-6">
              <div className="ftco-footer-widget mb-4">
                ...
                <div className="block-23 mb-3">
                  <ul>
                    <li><span className="icon icon-map-marker"></span><span className="text">Demo Address ,PIN,UP, India</span></li>
                    <li><Link to="#"><span className="icon icon-phone"></span><span className="text">9876543210</span></Link></li>
                    <li><Link to="#"><span className="icon icon-envelope"></span><span className="text">demo@gmail.com</span></Link></li>
                  </ul>
                </div>
              </div>
            </div>
